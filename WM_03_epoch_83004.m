function [epochedEEG, epochedEEG_baseline] = WM_03_epoch_83004(bandpassedEEG)
...
% baseline: 0, +4 sec: segments of continuous baseline period
    ...
    % iterate over blocks
    for i = 1:4 % there are 4 blocks in VR session
        ...
        for search_idx = 1:3
            ...
            EEG.event(searchFoundInBlock(search_idx)).block = block_idx(i);
            EEG.event(searchFoundInBlock(search_idx)).rotation = 0;
            EEG.event(searchFoundInBlock(search_idx)).session = 1;
        ...
        for search_idx = 1:3
            ...
            EEG.event(searchStartInBlock(search_idx)).block = block_idx(i);
            EEG.event(searchStartInBlock(search_idx)).rotation = 0;
            EEG.event(searchStartInBlock(search_idx)).session = 1;
        ...
        for guess_idx = 1:4
            ...
            EEG.event(guessStartInBlock(guess_idx)).block = block_idx(i);
            EEG.event(guessStartInBlock(guess_idx)).session = 1;
    ...
    % iterate over blocks
    for block_idx = 1:6 % there are 6 blocks in Desktop session
        ...
        % choose the block that is in the session
        if block_idx == 1 || block_idx == 2 || block_idx == 5 || block_idx == 6
        ...
        for search_idx = 1:3
            ...
            EEG.event(searchFoundInBlock(search_idx)).rotation = 0;
            EEG.event(searchFoundInBlock(search_idx)).session = 2;
        ...
        for search_idx = 1:3
            ...
            EEG.event(searchStartInBlock(search_idx)).rotation = 0;
            EEG.event(searchStartInBlock(search_idx)).session = 2;
        ...
        for guess_idx = 1:4
            ...
            EEG.event(guessStartInBlock(guess_idx)).session = 2;
    ...
    % Second: extract epochs from trials
    %-----------------------------------------------------------------------------
